...
author: "Manuel L. Estupiñan-Owen, Yeison Garcia y Paola Peralta"
...
library(dplyr)
colnames(microalgas)[which(colnames(microalgas) == "Grupos")] <- "Tributarios" # Renombrar Grupos por Tributarios
...
## [Figuras de barras]{style="color: #3690c0;"}

Los graficos de barras se elaboraron con Exel, utilizando las ocho replicas dentro de cada tributario.

![Densidad total de taxones en cada replica para los tres tributario. Donde VIC: La Victoria; PIC: La Picua y JAB: Jabali](Densidad total de microalgas en cada tributario..png){#fig-Figura8 fig-align="center"}
...
![Densidad de los diferentes taxones en cada replica para los tres tributario. Donde VIC: La Victoria; PIC: La Picua y JAB: Jabali](Densidad por cada genero de microalgas perifíticas en cada tributario..png){#fig-Figura9 fig-align="center"}
